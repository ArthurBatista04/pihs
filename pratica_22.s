...
.section .data
	...
	txtPedeCpf: 	.asciz "\nDigite sua cpf => "
	txtMostraNome: 	.asciz "\nNome: %s\n"
	txtMostraIdade: 	.asciz "\Idade: %s\n"
	txtMostraCpf: 	.asciz "\Cpf: %s\n"
	txtMostraProf: 	.asciz "\nProfissao: %s\n"
	txtMostraSal: 	.asciz "\nSalario: R$ %.2lf\n"
	txtFim: 	.asciz "\nFinalizando ...\n>>> Veja o Arquivo como Ficou!\n\n"
	nomeArq: 	.space 50
	registro: 	.space 143 # nome (70), profissao (50), salario (8 = double), idade (4), cpf(11)
	tam: 		.int 143
	lixo: 		.int 0
	opcao: 		.int 0
	iformato: 	.asciz "%d"
...
# Desafio Opcional: Modifique o programa e acrescente os campos idade e CPF. 
# Fa�a as altera��es que forem necess�rias para ele funcionar. 
# Depois, ajuste o c�digo para ele n�o ficar abrindo e fechando a cada escrita, de tal forma que para uma sequencia contigua de escritas, 
# o arquivo serah aberto antes da primeira e serah fechado ap�s a �ltima escrita. 
